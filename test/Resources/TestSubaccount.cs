...
namespace Plivo.test.Resources
{
    ...
    public class TestSubaccount : BaseTestCase
    {
        ...
        public void TestSubaccountCreate()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/subaccountCreateResponse.json"
                );
        ...
        public void TestAccountGet()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/subaccountGetResponse.json"
                );
            Setup<Account>(
                200,
                response
        ...
        public void TestAccountList()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/subaccountListResponse.json"
                );
            Setup<Account>(
                200,
                response
        ...
        public void TestAccountModifyResponse()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/subaccountModifyResponse.json"
                );
