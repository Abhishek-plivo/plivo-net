...
namespace Plivo.test.Resources
{
    ...
    public class TestCall : BaseTestCase
    {
        ...
        public void TestCallCreate()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/callCreateResponse.json"
                );
        ...
        public void TestCallList()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/callListResponse.json"
                );
        ...
        public void TestCallGet()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/callGetResponse.json"
                );
        ...
        public void TestLiveCallList()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/liveCallListGetResponse.json"
                );
        ...
        public void TestLiveCallGet()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/liveCallGetResponse.json"
                );
            Assert.IsNotEmpty(response);
        ...
        public void TestCallTranfer()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/callUpdateResponse.json"
                );
        ...
        public void TestCallRecord()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/liveCallRecordCreateResponse.json"
                );
            Setup<UpdateResponse<Call>>(202, response);
        ...
        public void TestCallSpeak()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/liveCallSpeakCreateResponse.json"
                );
            Setup<UpdateResponse<Call>>(202, response);
        ...
        public void TestCallPlay()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/liveCallPlayCreateResponse.json"
                );
            Setup<UpdateResponse<Call>>(202, response);
        ...
        public void TestCallStopSpeaking()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/liveCallSpeakDeleteResponse.json"
                );
            Setup<DeleteResponse<Call>>(204, response);
