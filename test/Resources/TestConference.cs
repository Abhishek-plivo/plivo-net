...
namespace Plivo.test.Resources
{
    ...
    public class TestConference : BaseTestCase
    {
        ...
        public void TestConferenceList()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceListResponse.json"
                );
        ...
        public void TestConferenceGet()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceGetResponse.json"
                );
        ...
        public void TestConferenceDelete()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceDeleteResponse.json"
                );
        ...
        public void TestConferenceDeleteAll()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceDeleteAllResponse.json"
                );
            Setup<Conference>(204, response);
        ...
        public void TestConferenceMemberDelete()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceMemberDeleteResponse.json"
                );
        ...
        public void TestConferenceMemberKick()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceMemberKickCreateResponse.json"
                );
            Setup<ConferenceMemberActionResponse>(204, response);
        ...
        public void TestConferenceMemberMute()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceMemberMuteCreateResponse.json"
                );
            Setup<ConferenceMemberActionResponse>(204, response);
        ...
        public void TestConferenceMemberPlay()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceMemberPlayCreateResponse.json"
                );
            Setup<ConferenceMemberActionResponse>(204, response);
        ...
        public void TestConferenceMemberStopPlaying()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceMemberPlayDeleteResponse.json"
                );
            Setup<ConferenceMemberActionResponse>(204, response);
        ...
        public void TestConferenceMemberSpeak()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceMemberSpeakCreateResponse.json"
                );
            Setup<ConferenceMemberActionResponse>(204, response);
        ...
        public void TestConferenceMemberDeaf()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceMemberDeafCreateResponse.json"
                );
            Setup<ConferenceMemberActionResponse>(204, response);
            ...
            Assert.IsEmpty(
                Util.Compare(
                    response, 
                    Api.Conference.DeafMember(name, new List<string>(){"11","123"})
                )
            );
        ...
        public void TestConferenceRecord()
        {
            ...
            var response = 
                System.IO.File.ReadAllText(
                    SOURCE_DIR + @"test/Mocks/conferenceRecordCreateResponse.json"
                );
