...
namespace Plivo.Resource.Subaccount
{
    public class SubaccountInterface : ResourceInterface
    {
        ...
        {
            var data = CreateData(
                GetMethodParameterProperties(MethodBase.GetCurrentMethod().GetParameters()),new {name, enabled});
        ...
        {
            var data = CreateData(
                GetMethodParameterProperties(MethodBase.GetCurrentMethod().GetParameters()),new {limit, offset});
